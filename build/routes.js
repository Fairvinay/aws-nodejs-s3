...
const auth0_controller_1 = require("./app/auth0/auth0.controller");
const admin_controller_1 = require("./app/admin/admin.controller");
...
const settings_controller_1 = require("./app/settings/settings.controller");
const auth_service_instance_1 = require("./app/auth/services/auth.service.instance");
